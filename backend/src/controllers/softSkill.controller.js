...
exports.createTask = async (req, res) => {
  try {
    ...
    const task = await SoftSkillTask.create({ title, description, deadline, teacher: teacherId });
...
exports.submitTask = async (req, res) => {
  try {
    ...
    if (submission) {
      ...
      submission = await SoftSkillSubmission.create({ task: taskId, student: studentId, presentationUrl });
    }
