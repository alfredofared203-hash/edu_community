...
export default function SoftSkillsPage() {
  ...
  return (
    <div
      className="p-4 md:p-8 max-w-[1400px] mx-auto bg-[#F9FAFC] min-h-screen text-right"
      dir="rtl"
    >
      <div className="bg-white rounded-3xl p-6 md:p-8 mb-8 border border-gray-100 shadow-sm relative overflow-hidden flex flex-col justify-center min-h-[160px]">
        ...
        <p className="text-xs md:text-sm text-gray-500 leading-relaxed max-w-3xl font-medium">
          اكتشف قوة المهارات الناعمة في تحويل مسارك المهني والأكاديمي. نحن نركز
          على تمكينك من خلال تطوير التواصل، القيادة، وإدارة الوقت لضمان تميزك
          في سوق العمل الحديث وبناء علاقات اجتماعية ناجحة.
        </p>
      </div>
